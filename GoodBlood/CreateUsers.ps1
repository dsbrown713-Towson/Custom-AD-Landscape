$userlist = Get-Content C:\Users\$env:USERNAME\Desktop\GoodBlood\US_Names.csv 		#Check File Location/Name
$passlist = Get-Content C:\Users\$env:USERNAME\Desktop\GoodBlood\PasswordList.txt
